...
import 'produit_vente_model.dart';
export 'produit_vente_model.dart';

class ProduitVenteWidget extends StatefulWidget {
  const ProduitVenteWidget({
    Key? key,
    this.productitems,
  }) : super(key: key);
  ...
  @override
  _ProduitVenteWidgetState createState() => _ProduitVenteWidgetState();
}

class _ProduitVenteWidgetState extends State<ProduitVenteWidget> {
  late ProduitVenteModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProduitVenteModel());
  }
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<ProductCollectionRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final produitVenteProductCollectionRecord = snapshot.data!;
        return Scaffold(
          key: scaffoldKey,
                ...
                title: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        produitVenteProductCollectionRecord.name!,
                        maxLines: 1,
                        style:
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              ClipRRect(
                                                ...
                                                child: Image.network(
                                                  produitVenteProductCollectionRecord
                                                      .userPhoto!,
                                                  width: 100.0,
                                                  height: 100.0,
                                                  fit: BoxFit.cover,
                                          ...
                                          child: Padding(
                                            ...
                                            child: FFButtonWidget(
                                              onPressed: () async {
                                                ...
                                                await produitVenteProductCollectionRecord
                                                    .reference
                                                    .update(
